...
def list_of_items(items):
    ...
    str_items = ""
    for item in items: # loops for each item in the items list
        str_items = str_items + item["name"] + ", " # adds the item name of an item to the list
    return str_items.rstrip(", ") # strips the "," from the end of the string and returns the string
...
def print_room_items(room):
    ...
    if room["items"] != []: # checks if items section of room list is not empty
        print("There is", list_of_items(room["items"]), "here.\n") #runs listofitems function with list of
        # items in the room given and prints them out
...
def print_menu(exits, room_items, inv_items):
    ...
    for item in room_items:
        print("TAKE" + item["id"].upper() + " to take " + item["name"] + ".") #looks up item ID from dictionary and also the name

    inv_items = inventory #inv_items set to the player's inventory list
    for item in inv_items:
        print("DROP" + item["id"].upper() + " to drop " + item["name"] + ".") #looks up item ID from dictionary and also the name
